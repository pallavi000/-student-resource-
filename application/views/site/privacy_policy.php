<div id="content">
        <header class="list-header">
            ...
            <h1>Privacy Policy for Tutorials Center Point</h1>

        </header>
        <div class="container">
            <div class="row">
                <div class="text-justify">
                    <p>At Scholar Materials, accessible from www.scholarmaterials.com, one of our main priorities is the
                        privacy of our visitors. This Privacy Policy document contains types of information that is
                        collected and recorded by Scholar Materials and how we use it.</p>
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                        website with regards to the information that they shared and/or collect in Scholar Materials.
                    ...
                    <p>Scholar Materials follows a standard procedure of using log files. These files log visitors when
                    ...
                    <p>Like any other website, Scholar Materials uses 'cookies'. These cookies are used to store
                    ...
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                        that are used in their respective advertisements and links that appear on Scholar Materials,
                    ...
                    <p>Note that Scholar Materials has no access to or control over these cookies that are used by
                        third-party advertisers.</p>

                    <h2>Third Party Privacy Policies</h2>

                    <p>Scholar Materials's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                    ...
                    <p>Scholar Materials does not knowingly collect any Personal Identifiable Information from children
