                ...
                <div class="article-content text-left">
                    <div class="col-md-8">
                        <h3 style="background-color: #E2E1E9; color:#F7631B; padding: 10px;"
                            class=""><?php echo ucwords($category_result->title); ?>:: Recent Posts</h3>
                        <hr>

                        <?php
                        foreach ($paginationData['records'] as $row) {
                            $cat_data = News::getCategoryDataById($row->category_id);
                            if ($row->category_id == $category_result->id){
                            ?>
                            <div class="media">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="list-group" style="font-size: 1em; font-weight: 200">
                            ...
                            foreach ($trending_news as $row){
                                ...
                                ?>
                                <a href="<?php echo LINK_URL . "news/article/" . $row->url; ?>" class="list-group-item ">  <img src="<?php echo $row->image; ?>" style="width:30px; height: 30px; border-radius: 5px;"> <?php echo $row->title; ?></a>
                                <?php
                            }
                            ?>
                        </div>
