...
class ArticleController extends MainController
{
    ...
    public function __construct()
    {
        ...
        $this->data['article_model'] = $this->getModel("ArticleModel");
    }
    /*function inactive($value = NULL)
    {
        $model = $this->data['article_model'];
        $this->data = array();

        $model->condition = "status=:status";
        $model->params = array(":status"=>0);
        $model->findAll();
        $this->loadView("inactive",$this->data);
