...
class CelebritycategoryController extends MainController
{
    private $data = null;
    ...
    public function __construct()
    {
        ...
        $this->data['blog_category_model'] = $this->getModel("CelebrityCategoryModel");
    }
    ...
    function index($value = NULL)
    {
        ...
        $model = $this->data['blog_category_model'];
