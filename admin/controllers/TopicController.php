...
class TopicController extends MainController
{
    ...
    public function __construct()
    {
        ...
        $this->data['topic_model'] = $this->getModel("TopicModel");
    ...
    public function create($value = NULL)
    {
        ...
        if (isset($_POST[CONTROLLER])) {
            ...
            if (empty($attribute['type'])) {
                $this->setFlashedMessage("error", "topic type must be required!");
                $flag = false;
            }
        ...
        if (isset($_POST[CONTROLLER])) {
            ...
            if ($flag === true) {
                ...
                if ($update === true) {
                    ...
                    $this->setFlashedMessage("error", "Sorry, Duplicate entry.$update[2]");
                    $this->redirect(CONTROLLER . "/create");
                }
            }
