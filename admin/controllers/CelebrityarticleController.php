...
class CelebrityarticleController extends MainController
{
    private $data = null;
    ...
    public function __construct()
    {
        ...
        $this->data['blog_article_model'] = $this->getModel("CelebrityArticleModel");
    }
    ...
    function index($value = NULL)
    {
        ...
        $model = $this->data['blog_article_model'];
