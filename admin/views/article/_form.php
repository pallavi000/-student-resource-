            ...
            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="control-group">
                    <div class="controls">
                        ...
                        ?>
                        <select onchange="leaveChange(this)" class="span6" name="<?php echo CONTROLLER; ?>[topics_id]">
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <textarea name="<?php echo CONTROLLER; ?>[details]" id="details" class="span6"
                                  placeholder="Enter details" type="text"
                                  value=""><?php echo isset($editableData) ? htmlspecialchars($editableData->details) : ""; ?></textarea>
                        <script>CKEDITOR.replace('<?php echo CONTROLLER; ?>[details]')</script>
