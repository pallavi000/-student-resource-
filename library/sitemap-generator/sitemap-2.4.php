...
*************************************************************/
    ...
    //define ("SITE", "http://www.standardintech.com/");
    define ("SITE", $_url_);
    ...
    // weekly, daily, monthly, General information for search engines how often they should crawl the page.
    //define ("FREQUENCY", "daily");
    define ("FREQUENCY", $_frequency_);
